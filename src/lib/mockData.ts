...
export const mockIdeas: Idea[] = [
  {
    ...
    category: IdeaCategory.SOFTWARE, // Updated
  ...
  },
  {
    ...
    category: IdeaCategory.EDUCATION_LEARNING, // Updated
    ...
    upvotes: 230,
    coverImageUrl: 'https://placehold.co/600x400/3498DB/FFFFFF.png',
  },
  {
    id: '3',
    ...
    category: IdeaCategory.SUSTAINABILITY_ENVIRONMENT, // Updated
    userId: MOCK_USER_3.id,
    userName: MOCK_USER_3.name,
    userAvatarUrl: MOCK_USER_3.avatarUrl,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 3).toISOString(), // 3 days ago
    upvotes: 98,
    coverImageUrl: 'https://placehold.co/600x400/E67E22/FFFFFF.png',
  },
  {
    id: '4',
    ...
    category: IdeaCategory.CREATIVE_ARTS, // Updated
    userId: MOCK_USER_1.id,
    userName: MOCK_USER_1.name,
    userAvatarUrl: MOCK_USER_1.avatarUrl,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 5).toISOString(), // 5 hours ago
    upvotes: 188,
    coverImageUrl: 'https://placehold.co/600x400/8E44AD/FFFFFF.png',
  },
  {
    id: '5',
    ...
    category: IdeaCategory.HEALTH_WELLNESS, // Updated
    userId: MOCK_USER_2.id,
    userName: MOCK_USER_2.name,
    userAvatarUrl: MOCK_USER_2.avatarUrl,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5).toISOString(), // 5 days ago
    upvotes: 305,
    coverImageUrl: 'https://placehold.co/600x400/1ABC9C/FFFFFF.png',
  },
  {
    id: '6',
    ...
    category: IdeaCategory.NONPROFIT_SOCIAL, // Updated
    userId: MOCK_USER_1.id,
    userName: MOCK_USER_1.name,
    userAvatarUrl: MOCK_USER_1.avatarUrl,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 6).toISOString(), // 6 days ago
    upvotes: 120,
    coverImageUrl: 'https://placehold.co/600x400/E74C3C/FFFFFF.png',
  },
  {
    id: '7',
    ...
    upvotes: 205,
    coverImageUrl: 'https://placehold.co/600x400/F1C40F/333333.png',
  },
  {
    id: '8',
    ...
    category: IdeaCategory.EDUCATION_LEARNING, // Kept as Education & Learning
    userId: MOCK_USER_3.id,
    userName: MOCK_USER_3.name,
    userAvatarUrl: MOCK_USER_3.avatarUrl,
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 15).toISOString(), // 15 days ago
    upvotes: 165,
    coverImageUrl: 'https://placehold.co/600x400/FF69B4/FFFFFF.png',
  },
];
